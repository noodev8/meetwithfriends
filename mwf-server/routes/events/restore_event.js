...
=======================================================================================================================================
Method: POST
Purpose: Restores a cancelled event. Only the event creator or group organiser can restore.
    ...
    try {
        ...
        if (!isOrganiser && !isEventCreator) {
            return res.json({
                ...
                message: 'Only the organiser or event creator can restore this event'
            });
        }
