                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      children: [
                          ...
                          // Contact Admin (active members who are not the organiser)
                          if (membership?.isActive == true && !isOrganiser)
                            _buildContactAdminTile(),
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  maxLength: 1000,
                  decoration: InputDecoration(
                    hintText: 'Hi, I have a question about...',
                    hintStyle: const TextStyle(color: Color(0xFF94A3B8)),
                    filled: true,
                    fillColor: const Color(0xFFF8FAFC),
                    border: OutlineInputBorder(
                ...
                const SizedBox(height: 8),
                const Text(
                  'Minimum 10 characters. Your email will be shared so they can reply.',
                  style: TextStyle(
                    fontSize: 12,
                    color: Color(0xFF94A3B8),
                  ),
            ...
            ElevatedButton(
              onPressed: sending
                  ...
                  : () async {
                      ...
                      final result = await _groupsService.contactOrganiser(
                        widget.groupId,
                        message,
                      );
