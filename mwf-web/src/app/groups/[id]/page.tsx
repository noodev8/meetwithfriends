                                    ...
                                    {events.map(event => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                className="group block bg-white rounded-2xl border border-stone-200 hover:border-amber-200 hover:shadow-lg transition-all duration-300 overflow-hidden"
                                            >
                                                <div className="flex">
                                                    {/* Date column */}
                                                    <div className="flex-shrink-0 w-20 sm:w-24 bg-gradient-to-br from-amber-50 to-orange-50 p-4 flex flex-col items-center justify-center text-center border-r border-stone-100">
                                                        ...
                                                        <div className="flex items-start justify-between gap-2">
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-stone-500 mt-1">
                                                                    ...
                                                                    {event.location && (
                                                                        <span className="ml-2">
                                                                            <svg className="w-4 h-4 inline-block mr-1 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
